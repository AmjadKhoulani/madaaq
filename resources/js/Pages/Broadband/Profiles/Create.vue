...
<template>
    <AppleLayout title="Initialize Tier">
        <Head title="Provision Service Profile" />
        ...
        <div class="max-w-5xl mx-auto pb-24">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold tracking-tight mb-1">Provision Service Tier</h1>
                        <p class="text-[var(--app-secondary)] font-medium">Defining a new high-integrity speed profile</p>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="apple-card p-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div class="space-y-4 md:col-span-2">
                            ...
                            <input v-model="form.name" type="text" class="apple-input h-14 font-bold text-lg uppercase tracking-tight" placeholder="e.g. ULTIMATE-FIBER-50" required>
                        </div>
                    ...
                    <div class="apple-card p-10 space-y-10">
                        ...
                        <div class="space-y-8">
                            <div class="space-y-4">
                                ...
                                <div class="relative">
                                    <input v-model="form.speed_down" type="number" class="apple-input h-14 pl-16 font-bold text-lg" placeholder="50">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative">
                                    <input v-model="form.speed_up" type="number" class="apple-input h-14 pl-16 font-bold text-lg" placeholder="20">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative">
                                    <input v-model="form.data_limit_mb" type="number" class="apple-input h-14 pl-16 font-bold text-lg" placeholder="Leave empty for Unlimited">
                    ...
                    <div class="apple-card p-10 space-y-10">
                        ...
                        <div class="space-y-8">
                            <div class="space-y-4">
                                ...
                                <div class="relative">
                                    <input v-model="form.price" type="number" step="0.01" class="apple-input h-14 pl-16 font-bold text-lg" placeholder="45.00">
                            ...
                            <div class="p-8 bg-black text-white rounded-[2.5rem] relative overflow-hidden group">
                                ...
                                <div class="relative z-10">
                                     <p class="text-[9px] font-black text-white/40 uppercase tracking-widest mb-2">Automated Renewal protocol</p>
                                     <p class="text-sm font-medium opacity-80 leading-relaxed">Profiles initialized here will be synchronized to the global billing registry for automated lease renewals.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-10 apple-card p-12 bg-black text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10 flex items-center gap-8">
                        ...
                        <div>
                             <h4 class="text-lg font-bold uppercase tracking-tight">Sync Commitment</h4>
                             <p class="text-[9px] font-black text-white/40 uppercase tracking-widest mt-1">
                                Committing tier specs to edge controllers via API handshake protocol.
                             </p>
                        </div>
                    </div>

...
<template>
    <AppleLayout :title="'Modify ' + profile.name">
        <Head :title="'Hotspot Governance: ' + profile.name" />
        ...
        <div class="max-w-5xl mx-auto pb-24">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold tracking-tight mb-1">Modify Hub Profile</h1>
                        <p class="text-[var(--app-secondary)] font-medium">Adjusting velocity parameters for {{ profile.name }}</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="p-8 bg-black text-white rounded-[2.5rem] relative overflow-hidden group">
                                ...
                                <div class="relative z-10 flex items-center gap-6">
                                     ...
                                     <div>
                                         <p class="text-[9px] font-black text-white/40 uppercase tracking-widest mb-1">State Sync Protocol</p>
                                         <p class="text-sm font-medium opacity-80 leading-relaxed">Changes to velocity or name will trigger a background handshake with all selected edge nodes.</p>
                                     </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative z-10 flex items-center gap-8">
                        ...
                        <div>
                             ...
                             <p class="text-[9px] font-black text-white/40 uppercase tracking-widest mt-1">
                                Updating velocity parameters on edge controllers via background API protocol.
                             </p>
                        </div>
                    </div>
                    <div class="relative z-10 flex items-center gap-6">
                        ...
                        <button 
                            type="submit" 
                            class="px-12 py-5 bg-white text-black font-bold text-xs uppercase tracking-[0.2em] rounded-2xl shadow-2xl hover:bg-amber-500 hover:text-white transition-all hover:scale-105 active:scale-95 disabled:opacity-50 flex items-center gap-2"
                            :disabled="form.processing"
                        >
                            <Save class="w-4 h-4" /> Commit Profile Protocol
                        </button>
                    </div>
                </div>
            </form>

...
<div class="max-w-5xl mx-auto space-y-8">
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="flex items-center gap-6">
                ...
                <div>
                    ...
                    <p class="text-blue-200">رقم المشترك: <span class="font-mono bg-white/10 px-2 py-0.5 rounded ml-1">#{{ $client->id }}</span></p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="space-y-4">
            ...
            <a href="https://wa.me/966XXXXXXXX?text=مرحباً، أرغب بتجديد اشتراكي رقم {{ $client->id }}" target="_blank" class="flex items-center gap-4 p-5 bg-green-50 rounded-2xl border border-green-100 hover:bg-green-100 transition group">

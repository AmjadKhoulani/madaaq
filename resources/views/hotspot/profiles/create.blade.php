                                ...
                                <div class="space-y-2 max-h-40 overflow-y-auto custom-scrollbar">
                                    @forelse($routers as $router)
                                        <label class="flex items-center gap-2 hover:bg-white p-1 rounded cursor-pointer transition">
                                            <input type="checkbox" name="targets[]" value="router_{{ $router->id }}" class="rounded border-gray-300 text-purple-600 focus:ring-purple-500 bg-white">
                            ...
                            <div>
                                ...
                                <div class="space-y-2 max-h-40 overflow-y-auto custom-scrollbar">
                                    @forelse($servers as $server)
                                        <label class="flex items-center gap-2 hover:bg-white p-1 rounded cursor-pointer transition">
                                            <input type="checkbox" name="targets[]" value="server_{{ $server->id }}" class="rounded border-gray-300 text-purple-600 focus:ring-purple-500 bg-white">

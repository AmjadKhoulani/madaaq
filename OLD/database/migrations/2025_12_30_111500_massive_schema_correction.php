...
return new class extends Migration
{
    ...
    {
        // Fix mobile_apps table - it was missing almost everything
        ...
        // Fix device_models table
        Schema::table('device_models', function (Blueprint $table) {
            if (!Schema::hasColumn('device_models', 'image_url')) {
    ...
    public function down(): void
    {
        Schema::table('mobile_apps', function (Blueprint $table) {
            $table->dropColumn([
                'tenant_id', 'app_name', 'app_name_en', 'package_name', 'description',
                'icon_path', 'primary_color', 'secondary_color', 'contact_email', 
                'contact_phone', 'website', 'status', 'is_paid', 'price', 
                'aab_file_path', 'submitted_at', 'completed_at'
            ]);
        });
